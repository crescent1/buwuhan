        ...
        <ul class="sidebar-menu">
            ...
            @if (Auth::user())
                ...
                @if (Auth::user()->type == 0 || Auth::user()->type == 1)
                    <li class="{{in_array(Route::currentRouteName(), ['event.index', 'guest.index']) ? 'active': ''}}"><a class="nav-link" href="{{ route('event.index') }}"><i class="fas fa-calendar-alt"></i><span>Events</span></a></li>
                @endif
            @endif
        </ul>
    </aside>
